            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                <div className="space-y-4">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-xs font-bold uppercase tracking-wider text-slate-500">Bank Name</FormLabel>
                                {!manualBank ? (
                                    ...
                                    <FormControl>
                                        <Input {...field} className="h-11 text-sm" placeholder="Enter bank name manually" />
                                    </FormControl>
                                )}
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-xs font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
                                    Account Number <CreditCard className="w-3.5 h-3.5 text-blue-500" />
                                </FormLabel>
                                <FormControl>
                                    <Input {...field} className="h-11 text-sm" placeholder="Enter bank account number" />
                                </FormControl>
                                <FormMessage className="text-[10px]" />
                            </FormItem>
                        )}
                ...
                <div className="space-y-4">
                    <FileUploadField
                        label="Bank Passbook Front / Statement"
                        description="Verified proof of account ownership"
