                                            ...
                                            paginatedOrders.map(order => {
                                                ...
                                                return (
                                                    <tr key={order.id} className={`transition-colors ${isMissingFromSync ? 'bg-orange-50 hover:bg-orange-100' :
                                                        ...
                                                        {isColumnVisible('receivedDate') && <td className="px-3 py-1.5 text-slate-600 text-[10px] whitespace-nowrap">{order.receivedDate ? new Date(order.receivedDate).toLocaleDateString() : (order.statusDate ? new Date(order.statusDate).toLocaleDateString() : '-')}</td>}
