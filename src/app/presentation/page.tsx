                ...
                <div className="flex flex-col space-y-6 h-full justify-center max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3.5">
                        {[
                            ...
                            <div key={idx} className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex flex-col justify-between space-y-3 shadow-lg relative overflow-hidden group hover:border-slate-700/60 transition-colors">
                                <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${section.color}`} />
                                <div className="space-y-1">
                                    <div className="text-[10px] font-black text-slate-500 font-mono tracking-widest uppercase">{section.num}</div>
                                    <h4 className="text-xs font-bold text-slate-200">{section.title}</h4>
                                    <p className="text-[10px] text-slate-400 leading-normal font-medium">{section.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
        ...
        },
        {
            ...
            content: (
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-8 h-full items-center max-w-5xl mx-auto">
                    ...
                    <div className="lg:col-span-3 bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-4 shadow-xl">
                        <div className="flex justify-between items-center border-b border-slate-800 pb-2.5">
                            <span className="text-xs font-bold text-slate-200 flex items-center gap-1.5"><Layers className="w-4 h-4 text-blue-400" /> Project Workspace Overview</span>
            ...
            content: (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full items-center max-w-4xl mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-xs text-slate-300 font-medium font-medium">
                            <li className="flex items-start gap-2">
                                <span className="text-emerald-400 font-bold">•</span>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-8 h-full items-center max-w-5xl mx-auto">
                    ...
                    <div className="lg:col-span-3 bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-4 shadow-xl">
                        ...
                        <div className="bg-slate-950/50 p-2.5 rounded-lg border border-slate-850/80 space-y-2">
                            <div className="text-[9px] font-bold text-slate-405 uppercase tracking-wider">Contractor Efficiency Rankings</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 h-full items-center max-w-4xl mx-auto">
                    <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl space-y-4 shadow-xl">
                        ...
                        <div className="space-y-2 pt-2 text-[10px]">
                            <div className="flex justify-between items-center p-2 bg-slate-950/40 rounded border border-slate-800">
                    ...
                    <div className="w-full max-w-7xl bg-slate-900/50 border border-slate-800 p-3 sm:p-6 md:p-10 rounded-2xl backdrop-blur-xl shadow-2xl flex flex-col justify-between min-h-[calc(100dvh-180px)] lg:min-h-[520px]">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-850 pb-4 mb-4">
                            ...
                            <span className="text-[10px] font-black text-slate-500 font-mono bg-slate-950/60 px-2.5 py-0.5 rounded-full border border-slate-850">
                                {slide.id < 10 ? '0' : ''}{slide.id} / {slides.length}
                            </span>
                        </div>
