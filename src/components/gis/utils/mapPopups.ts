export function getCablePopupHtml(seg: { id?: string; status?: string; segmentNumber?: string | number; length?: number; cableType?: string; fiberCount?: number }, route: { name?: string; cableType?: string }): string {
...
export function getRoutePopupHtml(route: { name?: string; routeLength?: number }): string {
...
export function getGeoJsonCablePopupHtml(route: { name?: string }, layerName: string): string {
...
export function getPolePopupHtml(pole: { poleNumber?: string | number; poleType?: string; height?: number; status?: string }, lat: number, lng: number): string {
...
export function getClosurePopupHtml(closure: { closureType?: string; capacity?: string | number; notes?: string }, lat: number, lng: number, titleText: string, dpName: string): string {
...
export function getChamberPopupHtml(ch: { chamberNumber?: string | number; chamberType?: string; status?: string; notes?: string }, lat: number, lng: number): string {
...
export function getRoadPopupHtml(road: { roadName?: string; length?: number; authority?: string; roadType?: string }): string {
...
export function getAssetPopupHtml(asset: { assetName?: string; assetCode?: string; assetType?: string; status?: string }, lat: number, lng: number): string {
...
export function getPlannedFeedPointPopupHtml(cl: { index: number }): string {
...
export function getPlannedClosurePopupHtml(cl: { index: number; closureType?: string; capacity?: string | number; notes?: string }, icon: string, isFDP: boolean): string {
...
export function getPlannedPolePopupHtml(pole: { index: number; height?: number; poleType?: string }): string {
...
export function getPlannedCablePopupHtml(cable: { index: number; length: number; cableType?: string; fiberCount?: number }): string {
