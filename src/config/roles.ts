...
export const ROLE_GROUPS = {
    ...
    FINANCE_APPROVERS: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'FINANCE_MANAGER'],
    FINANCE_ALL: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'FINANCE_MANAGER', 'FINANCE_ASSISTANT'],
    STORES_MANAGERS: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'STORES_MANAGER'],
    STORES_ALL: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'STORES_MANAGER', 'STORES_ASSISTANT'],
    PROJECT_MANAGERS: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'MANAGER', 'OSP_MANAGER', 'AREA_MANAGER'],
