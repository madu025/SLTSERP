...
export const ROLE_CATEGORIES: Record<string, string[]> = {
    ...
    'OSP & Operations': ['AREA_MANAGER', 'ASSISTANT_ENGINEER', 'AREA_COORDINATOR', 'QC_OFFICER'],
    'OSP Project': ['ENGINEER', 'OSP_ENGINEER', 'CIVIL_SUPERVISOR', 'CABLE_SPLICER'],
...
export const ROLE_GROUPS = {
    ...
    // QA audit: CONTRACTOR_SUPERVISOR removed — contractor material needs flow
    // through the contractor portal, never the internal MRN endpoints.
    MATERIAL_REQUESTERS: ['SUPER_ADMIN', 'ADMIN', 'CEO', 'HEAD_OF_OSP', 'OSP_MANAGER', 'AREA_MANAGER', 'ENGINEER', 'ASSISTANT_ENGINEER', 'AREA_COORDINATOR', 'STORES_MANAGER', 'STORES_ASSISTANT', 'PROCUREMENT_OFFICER'],
