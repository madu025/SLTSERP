---
name: migration-plan
description: Migration guide converting the SLTSERP monolithic Next.js architecture to the Service-Repository pattern. Use when migrating API route logic into the service layer, continuing the architecture migration, or refactoring route handlers into services.
---
